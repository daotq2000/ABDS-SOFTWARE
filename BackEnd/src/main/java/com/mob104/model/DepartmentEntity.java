...
@Entity
@Table(name = "department", schema = "mob104", catalog = "")
public class DepartmentEntity {
    ...
    public boolean equals(Object o) {
        ...
        return departmentId == that.departmentId &&
                directorateId == that.directorateId &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(departmentId, directorateId, contactId, shortDepcription, address1, postcode, cityTown, nationCountry, country, fullDescription, sicCode, phone, fax, email, website, charityNumber, companyNumber);
    }
}
